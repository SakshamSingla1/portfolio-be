...
public class LandingFeatureResponse extends AuditableResponse {
    private Long id;
    ...
    public LandingFeatureResponse(Long id, String iconName, String colorKey, String title, String description,
