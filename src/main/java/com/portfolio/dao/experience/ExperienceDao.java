...
public class ExperienceDao {
    ...
    public Page<ExperienceResponse> findByCriteria(Long profileId, String search, EmploymentStatusEnum employmentStatus, Pageable pageable){
        return experienceRepository.findByCriteria(profileId, search, employmentStatus, pageable);
    }
}
