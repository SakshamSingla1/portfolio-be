...
public class PermissionController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ResponseModel<PermissionResponseDTO>> getPermissionById(@PathVariable String id) throws GenericException {
    ...
    public ResponseEntity<ResponseModel<Page<PermissionResponseDTO>>> getAllPermissions(
        ...
        Page<PermissionResponseDTO> response = permissionService.getAllPermissionsPaginated(pageable, search, permissionIds);
        return ApiResponse.respond(
                response,
