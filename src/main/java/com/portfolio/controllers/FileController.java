...
public class FileController {
    ...
    @Operation(summary = "Upload a file and link it to a resource")
    @PostMapping("/upload")
    ...
    @Operation(summary = "Get all files for a resource")
    ...
    @Operation(summary = "Delete all files for a resource")
